...
public final class FileAdapter extends RecyclerView.Adapter<FileAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull final ViewGroup parent, int viewType) {
        final View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.downloads_list_model, parent, false);
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        holder.titleTextView.setText(uri.getLastPathSegment().replace("st22","").replaceAll("-"," ").replace("_","").toUpperCase());
            ...
            case COMPLETED: {
                ...
                holder.actionButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        playVideo.setDataAndType(Uri.parse(downloadData.download.getFile()), "video/mp4");
        ...
        holder.itemView.setOnLongClickListener(v -> {
            ...
            new AlertDialog.Builder(context)
                    .setMessage(context.getString(R.string.delete_title, uri12.getLastPathSegment().replace("st22","").replaceAll("-"," ").replace("_","")))
